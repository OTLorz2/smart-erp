...
import { getSuppliers, getMaterials, createPurchaseOrder, getPurchaseOrder, getPurchaseOrderItems } from '@/api'
...
async function loadOrder() {
  ...
  if (id) {
    ...
    const [orderRes, itemsRes] = await Promise.all([
      ...
      getPurchaseOrderItems(Number(id))
    ])
    form.supplier_id = orderRes.data.supplier_id
