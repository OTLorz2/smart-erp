    ...
    <el-card>
      <template #header>
        <div class="card-header">
          <span>采购订单</span>
          <el-button type="primary" @click="router.push('/purchase/order-form')">新建订单</el-button>
        </div>
      </template>
      ...
      <el-table :data="orders" v-loading="loading">
        ...
        <el-table-column prop="supplier_id" label="供应商ID" />
        ...
        <el-table-column label="操作" width="150">
          <template #default="{ row }">
            <el-button size="small" @click="router.push(`/purchase/order-form/${row.id}`)">编辑</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
